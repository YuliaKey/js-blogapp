...
form.addEventListener('submit', async event => {
  ...
  if (formIsValid(data)) {
    ...
    try {
      ...
      const response = await fetch("https://restapi.fr/api/dwwm_yuliia", {
